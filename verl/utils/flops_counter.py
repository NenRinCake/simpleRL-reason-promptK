...
import torch
from transformers import PretrainedConfig, Qwen2Config, LlamaConfig, Qwen3Config

VALID_CONFIG_TYPE = (Qwen2Config, LlamaConfig, Qwen3Config)
...
class FlopsCounter:
    ...
    def _estimate_qwen2_flops(self, tokens_sum, batch_seqlens, delta_time):
        assert isinstance(self.config, (Qwen2Config, LlamaConfig, Qwen3Config))
